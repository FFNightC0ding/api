...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if ip.startswith(('35', '34', '104.196')):
            ...
            if ip:  # Only try to get IP info if we have an IP
                try:
                    ...
                    # Handle any errors that might occur during IP info lookup
